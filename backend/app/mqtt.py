...
class MQTT:
    ...
    sub_topics = [("620172829_pub", 0), ("620172829", 0), ("620172829_sub", 0)] #  A list of tuples of (topic, qos). Both topic and qos must be present in the tuple.
    ...
    def __init__(self,mongo):
        ...
        self.client.message_callback_add("620172829", self.gdp)
        self.client.message_callback_add("620172829_pub", self.toggle)
    ...
    def toggle(self,client, userdata, msg):    
        ...
        try:
            ...
            print(update)
            self.publish("620172829_sub", payload)
